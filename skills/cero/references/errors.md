...
| `CLOSED`           | A call on a closed context, or an open still in flight when `me` closes. A join waiting in `cero.open` when you cancel it, or when `me` closes: one you did not cancel resumes on the next open.                                                                                                                                                                                                                                                                                                                                                                                             | Reopen, or wait for the join to land.                          |
